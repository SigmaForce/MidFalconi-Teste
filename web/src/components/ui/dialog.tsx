      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground " +
            ...
            "gap-4 rounded-lg border border-muted " +
          ...
          <DialogPrimitive.Close
            ...
            className={cn(
              "absolute top-4 right-4 rounded-xs opacity-70 transition-opacity " +
                "hover:opacity-100 focus:outline-hidden focus:ring-2 focus:ring-primary " +
                "focus:ring-offset-2 focus:ring-offset-background disabled:pointer-events-none " +
